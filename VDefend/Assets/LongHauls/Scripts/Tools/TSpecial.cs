...
namespace TTiles
{
    ...
    public struct TileAxis
    {
        ...
        public static readonly TileAxis Up = new TileAxis(0, 1);
        public static readonly TileAxis Down = new TileAxis(0, -1);
        public static readonly TileAxis Right = new TileAxis(1, 0);
        public static readonly TileAxis Left = new TileAxis(-1, 0);
    }
...
public class TimeCounter
{
    ...
    public TimeCounter(float duration=0)
    {
        SetTimer(duration);
    }
